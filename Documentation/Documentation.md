...
Filtered Variant calling file for variant that: 1. pass the GATK filter, 2. have genotype for 90% of BXD, 3. have a quality of 5000
The filtering was done using Scripts/LowLayer/VariantMerging/FilterRNAseqVariant.py


#### Path

/Variants/BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf 
...
[VCF filtered file](Documentation.html#bxd-variant-[vcf]); [GeneNetwork Genotype](Documentation.html#genenetwork-genotypes)
...
>First the file from RNA-seq and GeneNetwork are combined <br>
> python2 CombineGenotype.py GNmm9.Fred.GNformat.geno BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf Merge_step1.geno <br>
Then we get An improbable marker files, containing GeneNework variant discrepency with RNA-seq <br>
> python2 GetGenotypeRegion.py GNmm9.Fred.GNformat.geno BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf Merge_step1.geno 1 2>ImprobableGNMarkers.txt  <br>
> python2 GetGenotypeRegion.py GNmm9.Fred.GNformat.geno BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf Merge_step1.geno 2 2>ImprobableGNMarkers.txt <br>
> python2 GetGenotypeRegion.py GNmm9.Fred.GNformat.geno BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf Merge_step1.geno 3 2>ImprobableGNMarkers.txt <br>
.... <br>
> python2 GetGenotypeRegion.py GNmm9.Fred.GNformat.geno BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf Merge_step1.geno 19 2>ImprobableGNMarkers.txt <br>
> python2 GetGenotypeRegion.py GNmm9.Fred.GNformat.geno BXD.PFLiver.PFBrain.BTBrain.Hypo.VariantFiltration.annotated.90pct.5K.vcf Merge_step1.geno X 2>ImprobableGNMarkers.txt <br>
Set ImprobableGNMarkers.txt as 'U' in GeneNetwork file <br>
>  <br>
Recombine files <br>
>  <br>
Filter for genotypes <br>
> <br>
