...
OutputName<-"Cortex.NSD" 
ExpressionFile<-"/scratch/beegfs/monthly/SleepRegulation/BXD/BXD_mm10/exome/edgeR_normalized_log2CPM_Cortex_NSD.tab"
library(qvalue)
...
```{r}
PhenoExclude<-"/scratch/beegfs/monthly/SleepRegulation/BXD/BXD_mm10/cis-eQTL/Cortex_nsd/TranscripteQTLExclude.txt"
