...
ExpressionFile<-"/scratch/beegfs/monthly/SleepRegulation/BXD/BXD_mm10/exome/edgeR_normalized_log2CPM_Cortex_SD.tab"
library(qvalue)
...
The analysis was done with not log expression data for Stab2
